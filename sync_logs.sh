...
rsync -avz -e "ssh -p 61805" \
  root@174.88.252.119:/root/Monocular_Obstacle_Avoidance_System/logs/visualization_artifacts/ \
  "$TARGET_DIR/visualization_artifacts/"

# 5. Command 2: Sync the edge_session.jsonl file
rsync -avz -e "ssh -p 61805" \
  root@174.88.252.119:/root/Monocular_Obstacle_Avoidance_System/logs/edge_session.jsonl \
  "$TARGET_DIR/"
