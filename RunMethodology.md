...
# Install ONNX Runtime (used to quantize Depth Anything ONNX)
...
4. Quantizes Depth ONNX to `models/depth_anything_v2_vits.int8.onnx`
...
- `models/depth_anything_v2_vits.int8.onnx` (generated by dynamic QUInt8 quantization)
